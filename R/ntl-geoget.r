...
source("zonalstats.R") ##Zonal statistics function
source("viirs_client.R") ##Data download functions (work in progress)
source("ntl_internals.R") ##Data download functions (work in progress)
source("chirps_client.R") ##Data download functions (work in progress)
source("chirps_internals.R") ##Data download functions (work in progress)
...
surveydata <- surveyextraction %>%
  dplyr::mutate(merge_result = dplyr::case_when(layer >= 0 ~ 3,
                                                is.na(layer) ~ 1))
